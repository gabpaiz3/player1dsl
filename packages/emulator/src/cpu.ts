...
export class Cpu {
  ...
  step(): number {
    ...
    switch (opcode) {
      // --- LDA ---
      case 0xa9:
        this.a = this.setZN(this.fetch());
        break;
      case 0xa5:
        this.a = this.setZN(this.bus.read(this.addrZeroPage()));
        break;
      case 0xb5:
        this.a = this.setZN(this.bus.read(this.addrZeroPageX()));
        break;
      case 0xad:
        this.a = this.setZN(this.bus.read(this.addrAbsolute()));
        break;
      case 0xbd:
        this.a = this.setZN(this.bus.read(this.addrAbsoluteX(true)));
        break;
      case 0xb9:
        this.a = this.setZN(this.bus.read(this.addrAbsoluteY(true)));
        break;
      case 0xa1:
        this.a = this.setZN(this.bus.read(this.addrIndirectX()));
        break;
      case 0xb1:
        this.a = this.setZN(this.bus.read(this.addrIndirectY(true)));
        break;

      // --- LDX / LDY ---
      case 0xa2:
        this.x = this.setZN(this.fetch());
        break;
      case 0xa6:
        this.x = this.setZN(this.bus.read(this.addrZeroPage()));
        break;
      case 0xb6:
        this.x = this.setZN(this.bus.read(this.addrZeroPageY()));
        break;
      case 0xae:
        this.x = this.setZN(this.bus.read(this.addrAbsolute()));
        break;
      case 0xbe:
        this.x = this.setZN(this.bus.read(this.addrAbsoluteY(true)));
        break;
      case 0xa0:
        this.y = this.setZN(this.fetch());
        break;
      case 0xa4:
        this.y = this.setZN(this.bus.read(this.addrZeroPage()));
        break;
      case 0xb4:
        this.y = this.setZN(this.bus.read(this.addrZeroPageX()));
        break;
      case 0xac:
        this.y = this.setZN(this.bus.read(this.addrAbsolute()));
        break;
      case 0xbc:
        this.y = this.setZN(this.bus.read(this.addrAbsoluteX(true)));
        break;

      // --- STA / STX / STY ---
      case 0x85:
        this.bus.write(this.addrZeroPage(), this.a);
        break;
      case 0x95:
        this.bus.write(this.addrZeroPageX(), this.a);
        break;
      case 0x8d:
        this.bus.write(this.addrAbsolute(), this.a);
        break;
      case 0x9d:
        this.bus.write(this.addrAbsoluteX(false), this.a);
        break;
      case 0x99:
        this.bus.write(this.addrAbsoluteY(false), this.a);
        break;
      case 0x81:
        this.bus.write(this.addrIndirectX(), this.a);
        break;
      case 0x91:
        this.bus.write(this.addrIndirectY(false), this.a);
        break;
      case 0x86:
        this.bus.write(this.addrZeroPage(), this.x);
        break;
      case 0x96:
        this.bus.write(this.addrZeroPageY(), this.x);
        break;
      case 0x8e:
        this.bus.write(this.addrAbsolute(), this.x);
        break;
      case 0x84:
        this.bus.write(this.addrZeroPage(), this.y);
        break;
      case 0x94:
        this.bus.write(this.addrZeroPageX(), this.y);
        break;
      case 0x8c:
        this.bus.write(this.addrAbsolute(), this.y);
        break;
      ...
      // --- logic ---
      case 0x29:
        this.a = this.setZN(this.a & this.fetch());
        break;
      case 0x25:
        this.a = this.setZN(this.a & this.bus.read(this.addrZeroPage()));
        break;
      case 0x35:
        this.a = this.setZN(this.a & this.bus.read(this.addrZeroPageX()));
        break;
      case 0x2d:
        this.a = this.setZN(this.a & this.bus.read(this.addrAbsolute()));
        break;
      case 0x3d:
        this.a = this.setZN(this.a & this.bus.read(this.addrAbsoluteX(true)));
        break;
      case 0x39:
        this.a = this.setZN(this.a & this.bus.read(this.addrAbsoluteY(true)));
        break;
      case 0x09:
        this.a = this.setZN(this.a | this.fetch());
        break;
      ...
      case 0x59:
        ...
        break;
      case 0x24:
        this.bitTest(this.addrZeroPage());
        break;
      case 0x2c:
        this.bitTest(this.addrAbsolute());
        break;
      ...
      case 0x69:
        ...
        break;
      case 0x65:
        this.adc(this.bus.read(this.addrZeroPage()));
        break;
      case 0x75:
        this.adc(this.bus.read(this.addrZeroPageX()));
        break;
      case 0x6d:
        this.adc(this.bus.read(this.addrAbsolute()));
        break;
      case 0x7d:
        this.adc(this.bus.read(this.addrAbsoluteX(true)));
        break;
      case 0x79:
        this.adc(this.bus.read(this.addrAbsoluteY(true)));
        break;
      case 0xe9:
        this.sbc(this.fetch());
        break;
      case 0xe5:
        this.sbc(this.bus.read(this.addrZeroPage()));
        break;
      case 0xf5:
        this.sbc(this.bus.read(this.addrZeroPageX()));
        break;
      case 0xed:
        this.sbc(this.bus.read(this.addrAbsolute()));
        break;
      case 0xfd:
        this.sbc(this.bus.read(this.addrAbsoluteX(true)));
        break;
      case 0xf9:
        this.sbc(this.bus.read(this.addrAbsoluteY(true)));
        break;
      case 0xc9:
        this.compare(this.a, this.fetch());
        break;
      case 0xc5:
        this.compare(this.a, this.bus.read(this.addrZeroPage()));
        break;
      case 0xd5:
        this.compare(this.a, this.bus.read(this.addrZeroPageX()));
        break;
      case 0xcd:
        this.compare(this.a, this.bus.read(this.addrAbsolute()));
        break;
      case 0xdd:
        this.compare(this.a, this.bus.read(this.addrAbsoluteX(true)));
        break;
      case 0xd9:
        this.compare(this.a, this.bus.read(this.addrAbsoluteY(true)));
        break;
      case 0xe0:
        this.compare(this.x, this.fetch());
        break;
      case 0xe4:
        this.compare(this.x, this.bus.read(this.addrZeroPage()));
        break;
      case 0xec:
        this.compare(this.x, this.bus.read(this.addrAbsolute()));
        break;
      case 0xc0:
        this.compare(this.y, this.fetch());
        break;
      case 0xc4:
        this.compare(this.y, this.bus.read(this.addrZeroPage()));
        break;
      case 0xcc:
        this.compare(this.y, this.bus.read(this.addrAbsolute()));
        break;

      // --- inc / dec ---
      case 0xe6: {
        const a = this.addrZeroPage();
        this.bus.write(a, this.setZN(this.bus.read(a) + 1));
        break;
      }
      case 0xf6: {
        const a = this.addrZeroPageX();
        this.bus.write(a, this.setZN(this.bus.read(a) + 1));
        break;
      }
      case 0xee: {
        const a = this.addrAbsolute();
        this.bus.write(a, this.setZN(this.bus.read(a) + 1));
        break;
      }
      case 0xfe: {
        const a = this.addrAbsoluteX(false);
        this.bus.write(a, this.setZN(this.bus.read(a) + 1));
        break;
      }
      case 0xc6: {
      ...
      case 0x0a:
        ...
        break;
      case 0x06:
        this.aslMem(this.addrZeroPage());
        break;
      case 0x16:
        this.aslMem(this.addrZeroPageX());
        break;
      case 0x0e:
        this.aslMem(this.addrAbsolute());
        break;
      case 0x1e:
        this.aslMem(this.addrAbsoluteX(false));
        break;
      case 0x4a:
        ...
        break;
      case 0x46:
        this.lsrMem(this.addrZeroPage());
        break;
      case 0x56:
        this.lsrMem(this.addrZeroPageX());
        break;
      case 0x4e:
        this.lsrMem(this.addrAbsolute());
        break;
      case 0x5e:
        this.lsrMem(this.addrAbsoluteX(false));
        break;
      case 0x2a: {
        const c = this.getFlag(FLAG_C) ? 1 : 0;
        this.setFlag(FLAG_C, (this.a & 0x80) !== 0);
        this.a = this.setZN((this.a << 1) | c);
        break;
      }
      case 0x26:
        this.rolMem(this.addrZeroPage());
        break;
      case 0x36:
        this.rolMem(this.addrZeroPageX());
        break;
      case 0x2e:
        this.rolMem(this.addrAbsolute());
        break;
      case 0x3e:
        this.rolMem(this.addrAbsoluteX(false));
        break;
      case 0x6a: {
        const c = this.getFlag(FLAG_C) ? 0x80 : 0;
        this.setFlag(FLAG_C, (this.a & 0x01) !== 0);
        this.a = this.setZN((this.a >> 1) | c);
        break;
      }
      case 0x66:
        this.rorMem(this.addrZeroPage());
        break;
      case 0x76:
        this.rorMem(this.addrZeroPageX());
        break;
      case 0x6e:
        this.rorMem(this.addrAbsolute());
        break;
      case 0x7e:
        this.rorMem(this.addrAbsoluteX(false));
        break;
      ...
      // --- branches ---
      case 0x10:
        this.branch(!this.getFlag(FLAG_N));
        break;
      case 0x30:
        this.branch(this.getFlag(FLAG_N));
        break;
      case 0x50:
        this.branch(!this.getFlag(FLAG_V));
        break;
      case 0x70:
        this.branch(this.getFlag(FLAG_V));
        break;
      case 0x90:
        this.branch(!this.getFlag(FLAG_C));
        break;
      case 0xb0:
        this.branch(this.getFlag(FLAG_C));
        break;
      case 0xd0:
        this.branch(!this.getFlag(FLAG_Z));
        break;
      case 0xf0:
        this.branch(this.getFlag(FLAG_Z));
        break;
